...
public class JestTest {
    ...
    private static String typeName = "book";
    private static String elasticIps="http://192.168.43.86:9200";
    ...
    private static  JestClient getJestClient() {
        ...
        factory.setHttpClientConfig(new HttpClientConfig.Builder(elasticIps).connTimeout(60000).
                readTimeout(60000).multiThreaded(true).build());
    ...
    public static void insertBatch() {
        ...
        objs.add(new Book(1, "张三", "22","张三是个Java开发工程师","2018-4-25 11:07:42"));
        objs.add(new Book(2, "李四", "23","李四是个测试工程师","1980-2-15 19:01:32"));
        objs.add(new Book(3, "王五", "24","王五是个运维工程师","2016-8-21 06:11:32"));
